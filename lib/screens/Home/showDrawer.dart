  ...
  child: ListView(
    ...
    children: <Widget>[
      ...
      ListTile(
        ...
        onTap: () {
            ...
            Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MyAppotiments(userId: userId,),
      ...
      ListTile(
        ...
        onTap: () {
            ...
            Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => 
                          MainRefundPage(doctorId: userId)
      ...
      ListTile(
        ...
        onTap: () {
            ...
            Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => EditProfile(userid: this.userId,),
                          // settings: RouteSettings(
                          //   arguments: [catgary[index],this.userid],
                          // ),
                        ),
      ...
      ListTile(
        title: Text('Logout'),
        onTap: () {
          AuthService().signOut(context).then((onValue){
